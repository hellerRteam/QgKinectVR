...
namespace com.rfilkov.kinect
{
    ...
    public class KinectManager : MonoBehaviour
    {
        ...
        internal bool IsJointTracked(ulong userId, object tryGetValue)
        {
...
//            }
        ...
        internal Vector3 GetJointPosColorOverlay(long userId, int jointIndex, Camera mainCamera, Rect backgroundRect)
        {
            throw new NotImplementedException();
        }

        internal bool IsUserDetected()
        {
            throw new NotImplementedException();
        }
    }
